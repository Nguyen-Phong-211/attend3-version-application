...
class _RemindScreenState extends State<RemindScreen> {
  ...
  String selectedNotificationMethod = 'Email';
  String selectedRemindTime = 'Trước 10 phút';

  final TextEditingController titleController =
  TextEditingController(text: 'Nhắc nhở điểm danh');
  ...
  final List<String> notificationMethods = ['Email', 'Thông báo ứng dụng'];
  final List<String> remindTimes = ['Trước 30 phút', 'Trước 20 phút', 'Trước 10 phút'];

  void _submitReminder() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Đã tạo nhắc nhở điểm danh')),
    );
  }
  ...
  Widget _buildDropdown({
    ...
    return DropdownButtonFormField<String>(
      ...
      style: TextStyles.titleInput.copyWith(color: AppColors.black, fontFamily: 'Quicksand'),
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: TextStyles.titleInput.copyWith(color: Colors.grey),
        prefixIcon: Padding(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text('Tạo nhắc nhở', style: TextStyles.titleScaffold),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildDropdown(
                    hint: 'Hình thức thông báo',
                    items: notificationMethods,
                    value: selectedNotificationMethod,
                    onChanged: (val) => setState(() => selectedNotificationMethod = val!),
                    iconData: FontAwesomeIcons.bell,
                  ),
                  const SizedBox(height: 16),

                  _buildDropdown(
                    hint: 'Thời gian nhắc nhở',
                    items: remindTimes,
                    value: selectedRemindTime,
                    onChanged: (val) => setState(() => selectedRemindTime = val!),
