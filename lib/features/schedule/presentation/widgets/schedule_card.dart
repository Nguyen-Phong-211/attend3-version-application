          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  // AppIcon.iconClock,
                  const HeroIcon(HeroIcons.cursorArrowRays, size: 14,),
                  const SizedBox(width: 6),
                  Text(
                    'Tiết: ${item.lessonSlot}',
              ...
              Row(
                children: [
                  // AppIcon.iconClock,
                  const HeroIcon(HeroIcons.paperAirplane, size: 14),
                  const SizedBox(width: 6),
                  Text(
                    'Lớp: ${item.className}',
                    style: TextStyles.bodyNormal
              ...
              Row(
                children: [
                  // AppIcon.iconPerson,
                  const HeroIcon(HeroIcons.user, size: 14),
                  const SizedBox(width: 6),
                  Expanded(
                    child: Text(
                      'Giảng viên: ${item.host}',
                      style: TextStyles.bodyNormal,
              ...
              const SizedBox(height: 3),
              Text(
                'Thời gian còn lại: ${item.deadTime}',
